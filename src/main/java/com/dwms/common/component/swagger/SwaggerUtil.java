...
//            Property propK = PropertyBuilder.build(null == _prop0 ? "object" : _prop0.getType(), null == _prop0 ? null : _prop0.getFormat(), argsK);
//            propK.setName("key");
//
...
//            Property propV = PropertyBuilder.build(null == _prop1 ? "object" : _prop1.getType(), null == _prop1 ? null : _prop1.getFormat(), argsV);
//            propV.setName("value");
//
...
//        }
//
//        String[] s2 = new String[]{"A,B«List«C1»»", "Map«A,B»,C«List«D»»", "Map«Map«A,B»,C«List«D»»,Map«A,B»,C«List«D»»»,C«List«D»»"};
//        for (String s : s2) {
