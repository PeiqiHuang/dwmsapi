...
public class TransactionConfig {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.dwms..*.service.*.*(..)) || execution(* com.dwms..*.mgr.*.*(..))";
    ...
    public TransactionInterceptor txAdvice() {
        ...
        source.addTransactionalMethod("process*", txAttr_REQUIRED);
